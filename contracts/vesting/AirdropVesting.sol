...
contract AirdropVesting is MidleBaseVesting {

    /// @notice Constructor to initialize. AirdropVesting total amount is 10,000,000 MIDLE.
    ...
    constructor(address _midleAddress, uint256 _tgeTimestamp, address lockedUser )
        ...
        10000000 * 10 ** 18 ); // 10,000,000 $MIDLE
    }
}
